...
<?php 
		...
		if($amount==$total){
		  ...
		  echo "<a href='http://contactwithchinese.info/myshop/customers/my_account.php'>Go to your Account</a>";
		}
		else {
		  echo "<h2>Welcome Guest, Payment was failed</h2><br>";
		  echo "<a href='http://contactwithchinese.info/myshop'>Go to Back to shop</a>";
		}
        ...
        <table width='600' align='center' bgcolor='#FFCC99' border='2'>
            ...
            <h2> <a href='http://contactwithchinese.info/myshop'>Click here</a> to login to your account</h2>
            <h3> Thank you for your order @ - contactwithchinese.info</h3>
        </html>
        ";
